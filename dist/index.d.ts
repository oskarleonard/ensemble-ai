...
type InLockGitScanner = () => InLockGitScan | Promise<InLockGitScan>;
declare function listInLockGitProcesses(psOutput: string, parentDead: (pid: number) => boolean): InLockGitProcess[];
declare function summarizeInLockGit(procs: InLockGitProcess[]): InLockGitScan;
declare function resetInLockGitScanMemoForTests(): void;
declare function scanInLockGit(): InLockGitScan;
declare function scanInLockGitAsync(): Promise<InLockGitScan>;
...
declare function terminateOrphansSync(pids: number[]): number[];
declare function terminateOrphansAsync(pids: number[]): Promise<number[]>;
