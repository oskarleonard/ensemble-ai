...
declare function copyTransportConfig(repoRoot: string, bareRepo: string, git: GitRun): string[];
declare function scrubTransportConfig(bareRepo: string, addedKeys: string[], git: GitRun): void;
