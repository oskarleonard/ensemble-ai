import { R as ReviewerId, a as ReviewerConfig, S as SeatDiagnostics, b as ReviewFinding, c as ReviewPacket, T as TerminalState, d as StoredReview, e as Severity } from './types-CqveYXfa.js';
export { C as CONFIDENCES, f as CORE_REVIEWER_IDS, g as Confidence, h as CoreReviewerId, E as Evidence, M as ManifestEntry, P as PacketSection, i as REVIEWER_IDS, j as SEVERITIES, k as TERMINAL_STATES, l as enabledReviewerIds, m as isCoreReviewerId, n as isReviewerId, p as parseReviewerIds, o as parseSeatWindow, s as severityAtLeast, t as titleCase } from './types-CqveYXfa.js';
import { R as ReviewProfile } from './contracts--rMnnisv.js';
export { C as CI_EVIDENCE_SECTION_TITLE, D as DIFF_SECTION_TITLE, a as DIFF_USEFUL_FLOOR, F as FINDINGS_INSTRUCTIONS, P as PACKET_BUDGETS, b as PacketInput, c as ParsedReview, d as REVIEW_PROFILES, S as SECURITY_CLASSES, e as SECURITY_OBJECTIVE, f as SEVERITY_LABEL, g as SEVERITY_ORDER, h as SecurityClass, T as TRUNCATION_MARKER_RE, i as assembleCodePacket, j as classifySecurityFinding, k as evidenceRef, l as extractJsonBlock, m as isReviewProfile, o as oneOf, p as parseFindings, r as renderReviewPrompt, n as reviewerVisibleDiff, s as section, q as securityClassLabel, t as segmentsWithoutTruncationSplices, u as stripSecurityTag, v as stripTrailingCommas } from './contracts--rMnnisv.js';
...
declare function isUnder(child: string, parent: string): boolean;
...
type PreflightErrorKind = 'auth' | 'disallowed-root' | 'materialize-failed' | 'network' | 'no-such-pr' | 'not-a-repo' | 'sha-mismatch' | 'wrong-repo';
...
declare function missingConfig(want: ConfigEntries, have: ConfigEntries): ConfigEntries;
declare function transportEnv(entries: ConfigEntries, sshCommand: string | undefined): Record<string, string>;
declare function effectiveSshFrom(entries: ConfigEntries): string | undefined;
...
declare function reapWorktree(dir: string): void;
...
declare function reapWorktreeAsync(dir: string): Promise<void>;
...
declare function proxyEnv(url: string): Record<string, string>;
interface StartEgressProxyOpts {
    allowHosts: readonly string[];
    onDenial?: (denial: EgressDenial) => void;
    allowPorts?: readonly number[];
    port?: number;
}
declare function startEgressProxy(opts: StartEgressProxyOpts): Promise<EgressProxy>;
...
declare function renderVerifySandboxProfile(p: VerifySandboxPaths): string;
...
declare const REPO_LOCATION_ENV: readonly ["GIT_DIR", "GIT_WORK_TREE", "GIT_IMPLICIT_WORK_TREE", "GIT_NAMESPACE", "GIT_COMMON_DIR", "GIT_OBJECT_DIRECTORY", "GIT_ALTERNATE_OBJECT_DIRECTORIES", "GIT_INDEX_FILE", "GIT_CONFIG", "GIT_SHALLOW_FILE", "GIT_GRAFT_FILE", "GIT_CONFIG_PARAMETERS", "GIT_CEILING_DIRECTORIES", "GIT_REPLACE_REF_BASE"];
declare function scrubRepoEnv(env: Record<string, string | undefined>): Record<string, string | undefined>;
