...
declare function scanInLockGit(_scope: LockScope): InLockGitScan;
declare function scanInLockGitAsync(_scope: LockScope): Promise<InLockGitScan>;
type DeadHolderDecision = 'reclaim' | 'ttl';
...
declare const BUSY_BACKSTOP_FACTOR = 2;
